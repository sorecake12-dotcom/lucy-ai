...
<p>Press <strong style="color:#dde3ed">Remote Control</strong> in LUCY to get a new QR code.</p>
</div></body></html>""")
...
<p>Connecting to LUCY…</p>
    ...
    async def serve(self) -> None:
        ...
        print("[Dashboard] Press 'Remote Control' in LUCY UI to get the QR code.")
        await uvicorn.Server(cfg).serve()
