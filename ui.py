...
class LogWidget(QTextEdit):
    ...
    def __init__(self, parent=None):
        ...
        self._pos     = 0
        self._tag     = "sys"
        self._ai_name_lc = "lucy"   # updated when assistant name changes
        self._tmr = QTimer(self)
        self._tmr.timeout.connect(self._step)
    ...
    def _next(self):
        ...
        elif tl.startswith(_ai_pfx) or tl.startswith("lucy:") or tl.startswith("jarvis:"): self._tag = "ai"
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(_lbl("Configure LUCY before first boot.", 9, color=C.PRI_DIM))
        layout.addSpacing(6)
...
class CustomizeOverlay(QWidget):
    ...
    def __init__(self, assistant_name="LUCY", user_name="",
    ...
    def _save(self):
        name = self._name_input.text().strip() or "LUCY"
...
class AudioDeviceOverlay(_HudOverlay):
    ...
    def __init__(self, parent=None):
        ...
        self._in_box  = _row("MICROPHONE — what LUCY hears you with",
                             "input", get_input_device())
        lay.addSpacing(4)
        self._out_box = _row("SPEAKERS — what LUCY talks through",
...
class RemoteKeyOverlay(QWidget):
    ...
    def mark_connected(self) -> None:
        ...
        self._timer_lbl.setText("Phone connected — LUCY ready")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        ...
        self._assistant_name: str = (_cfg.get("assistant_name") or "LUCY").strip()
        ...
        try:
            ...
            # ── macOS — proper .app bundle (no Terminal window) ───────────────
                ...
                (app / "Contents" / "Info.plist").write_text(
                    ...
                    '  <key>CFBundleExecutable</key><string>LUCY</string>\n'
                    '  <key>CFBundleIdentifier</key>'
                    '<string>com.lucy.assistant</string>\n'
                    '  <key>CFBundleName</key><string>LUCY</string>\n'
    ...
    def _check_autostart(self) -> bool:
        ...
        try:
            if _OS == "Windows":
                ...
                try:
                    try:
                        winreg.QueryValueEx(key, "LUCY_AI")
                        return True
                ...
                return ((Path.home() / "Library" / "LaunchAgents"
                        / "com.lucy.assistant.plist").exists() or
                        (Path.home() / "Library" / "LaunchAgents"
                        / "com.jarvis.assistant.plist").exists())
            else:
                return ((Path.home() / ".config" / "autostart" / "lucy.desktop").exists() or
    ...
    def _toggle_autostart(self):
        ...
        try:
            ...
            if _OS == "Windows":
                ...
                if currently_on:
                    for k in ("LUCY_AI", "JARVIS_AI"):
                        try:
                            winreg.DeleteValue(reg, k)
                        except FileNotFoundError:
                            pass
                else:
                ...
                plist = plist_dir / "com.lucy.assistant.plist"
                if currently_on:
                    ...
                    plist.write_text(
                        ...
                        '"http://www.apple.com/DTDs/PropertyList-1.0.dtd">\n'
                        '<plist version="1.0"><dict>\n'
                        '  <key>Label</key><string>com.lucy.assistant</string>\n'
    ...
    def _open_customize(self):
        ...
        cw = self.centralWidget()
        ov = CustomizeOverlay(
            cfg.get("assistant_name", "LUCY") or "LUCY",
            cfg.get("user_name", ""),
    ...
    def _apply_name_update(self, name: str, user_name: str, ui_color: str = "",
        ...
        self._assistant_name = name.strip() or "LUCY"
    ...
    def _on_setup_done(self, key: str, os_name: str):
        ...
        if self._overlay:
            ...
            self._overlay = None
        self._apply_state("LISTENING")
        self._assistant_name = _read_full_config().get("assistant_name", "LUCY") or "LUCY"
...
class JarvisUI:
    def __init__(self, face_path: str, size=None):
        ...
        self._app.setApplicationName("LUCY")
        self._app.setApplicationDisplayName("LUCY")
        if sys.platform == "win32":
            try:
                import ctypes
                ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("lucy.ai.assistant")
            except Exception:
                pass
