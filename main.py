...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "LUCY checks these topics once a day and alerts the user when there is a new development. "
    ...
    },
    {
        ...
        "description": (
            ...
            "close the assistant, say goodbye, or stop Lucy. "
...
class JarvisLive:
    ...
    def _build_config(self) -> types.LiveConnectConfig:
        ...
        try:
            ...
            self._asst_name = (_cfg.get("assistant_name") or "LUCY").strip()
            _user_name = (_cfg.get("user_name") or "").strip()
        except Exception:
            self._asst_name = "LUCY"
            _user_name = ""
